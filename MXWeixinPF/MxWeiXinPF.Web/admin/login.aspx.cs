    ...
    public partial class login : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //string keys = "http://www.uweixin.cn/upgrade.ashx?u={0}&i={1}&v={2}";
                ...
                //string sj = "http://www.uweixin.cn/upgrade.ashx?t=1";
                //string notice = "http://www.uweixin.cn/upgrade.ashx?t=2";
