    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>微信支付商户号</dt>
                <dd>
                    <asp:TextBox ID="txtTenpayPartnerId" runat="server" CssClass="input normal" datatype="*3-100" sucmsg=" " nullmsg="*微信支付商户号（接口文档中的商户号MCHID）"></asp:TextBox>
            ...
            <dl>
                <dt>商户支付密钥Key</dt>
                <dd>
                    <asp:TextBox ID="txtTenpayKey" runat="server" CssClass="input normal" datatype="*32-32" sucmsg=" "></asp:TextBox>
            ...
            <dl style="display:none;">
                <dt>微信秘钥</dt>
                <dd>
                    <asp:TextBox ID="txtpaySignKey" runat="server" CssClass="input normal" datatype="*0-1000" sucmsg=" " nullmsg="*秘钥(paySignKey)"></asp:TextBox>
                    <span class="Validform_checktip">微信秘钥(paySignKey),非必填项</span>
                </dd>
            </dl> 
            <dl>
                <dt>微信appId</dt>
